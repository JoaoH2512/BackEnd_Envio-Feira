...
<link rel="stylesheet" href="../style.css">
    ...
    <style>
        ...
        * { box-sizing:border-box; }
        ...
        .rotulo { display:block; text-transform:uppercase; color:#716d6d; letter-spacing:.04em; font-size:10px; font-weight:bold; }
        ...
        .cartoes { display:grid; grid-template-columns:repeat(4,1fr); gap:15px; margin:27px 0; }
        .cartao { background:#fff; border:1px solid var(--borda); border-radius:7px; box-shadow:0 4px 14px rgba(48,34,30,.05); }
        ...
        .situacao { display:inline-block; border-radius:12px; padding:4px 8px; font-size:9px; font-weight:bold; }
        .situacao.ok { background:#e3f2eb; color:#317254; } .situacao.pendente { background:#fff2cf; color:#a6750d; }
        ...
        .lateral .cartao { padding:15px; } .lateral h3 { color:#5a1d29; font-size:12px; margin:0 0 11px; padding-bottom:9px; border-bottom:1px solid var(--borda); }
        ...
        @media (max-width:900px) { .cartoes { grid-template-columns:repeat(2,1fr); } .avaliacao-layout { grid-template-columns:1fr; } .ilustracao { height:300px; } }
        @media (max-width:620px) { .container { width:calc(100% - 28px); } .cartoes { grid-template-columns:1fr 1fr; gap:8px; } .resumo { padding:11px; } .tabela-wrap { overflow-x:auto; } table { min-width:800px; } h1 { font-size:19px; } .notificacao { top:29px; } }
    </style>
</head>
<body>
    <header class="topo">
        <div class="container">
            <?php if ($pagina === 'avaliar'): ?>
                ...
                <span class="rotulo">Avaliações gerais</span>
                <h1>EcoSense</h1>
                <p class="subtitulo">Revise as informações para concluir a avaliação do projeto.</p>
            <?php else: ?>
                <span class="rotulo">Painel do professor</span>
        ...
        <?php if ($pagina === 'avaliar' && $modoVisualizacao): ?>
            <section class="cartao painel visualizacao">
        ...
        <?php elseif ($pagina === 'avaliar'): ?>
            <div class="avaliacao-layout">
                ...
                <aside class="lateral">
                    ...
                    <div class="cartao resumo-avaliacao">
        ...
        <?php else: ?>
            ...
            <section class="cartoes">
                <div class="cartao resumo"><div class="resumo-titulo">Projetos orientados</div><div class="resumo-numero"><?php echo count($projetos); ?></div><div class="resumo-rodape"><?php echo count($projetos); ?> projetos ativos</div><span class="resumo-icone"><?php echo icone('book'); ?></span></div>
                <div class="cartao resumo dourado"><div class="resumo-titulo">Avaliações pendentes</div><div class="resumo-numero"><?php echo $pendentes; ?></div><div class="resumo-rodape"><?php echo $pendentes; ?> aguardando</div><span class="resumo-icone"><?php echo icone('clock'); ?></span></div>
                <div class="cartao resumo azul"><div class="resumo-titulo">Avaliações concluídas</div><div class="resumo-numero"><?php echo $concluidas; ?></div><div class="resumo-rodape"><?php echo $concluidas; ?> este mês</div><span class="resumo-icone"><?php echo icone('check'); ?></span></div>
                <div class="cartao resumo verde"><div class="resumo-titulo">Média das notas finais</div><div class="resumo-numero"><?php echo nota($mediaGeral, 2); ?></div><div class="resumo-rodape">Conceito geral: <?php echo $conceitoGeral; ?></div><span class="resumo-icone"><?php echo icone('chart'); ?></span></div>
            </section>
                ...
                <table>
                    ...
                    <?php foreach ($projetos as $id => $projeto): ?>
                        <tr>
                            ...
                            <td><span class="situacao <?php echo $projeto['status'] === 'Avaliado' ? 'ok' : 'pendente'; ?>"><?php echo e($projeto['status']); ?></span></td>
