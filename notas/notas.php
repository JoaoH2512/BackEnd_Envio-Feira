    ...
    <style>
        ...
        * {
        ...
        .card {
            ...
            border: 1px solid var(--borda);
            border-radius: 7px;
            box-shadow: 0 4px 14px rgba(48, 34, 30, .05);
        }
        ...
        .resumo.dourado .resumo-numero {
            color: var(--dourado);
        }

        .resumo.azul .resumo-numero {
            color: var(--azul);
        }

        .resumo.verde .resumo-numero {
            color: var(--verde);
        }
        ...
        .resumo.dourado .resumo-icone {
            color: var(--dourado);
        }

        .resumo.azul .resumo-icone {
            color: var(--azul);
        }

        .resumo.verde .resumo-icone {
            color: var(--verde);
        }
        ...
        .tabela-wrap {
            ...
            border-radius: 7px;
            overflow: hidden;
            box-shadow: 0 3px 10px rgba(48, 34, 30, .03);
        }
